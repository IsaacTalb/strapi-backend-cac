...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    defaultSeo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.Required;
    established: Schema.Attribute.BigInteger &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    worldwidePartners: Schema.Attribute.Integer & Schema.Attribute.Required;
  };
}
...
export interface ApiStrategicPlanStrategicPlan
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::strategic-plan.strategic-plan'
    >;
    numberofProjects: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTechnicalityCategoryTechnicalityCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'technicality_categories';
  info: {
    displayName: 'Technicality Category';
    pluralName: 'technicality-categories';
    singularName: 'technicality-category';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::strategic-plan.strategic-plan': ApiStrategicPlanStrategicPlan;
      'api::technicality-category.technicality-category': ApiTechnicalityCategoryTechnicalityCategory;
